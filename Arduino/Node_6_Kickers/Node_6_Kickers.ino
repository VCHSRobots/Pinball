 ...
 * Sling Shot Kickers Control Unit 
 * 
 * *** Address = 6
 * 
 * This module is for the Sling Shot Kickers.  The hardware is set up to
 * control 3 coils, three lamps and 3 inputs.  
 * 
 * Note, this is a duplicate of the Jet Bumper node.  THe lamps do
 * not need to be wired up.
 * 
...
bool coil_enable[] = {true, true, true};   // CHANGE THIS BACK!!!
