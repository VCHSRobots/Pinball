 ...
 * *** Address = 8
 * 
 * This module is for the targets. The hardware is set up to
 * monitor 8 switches.
 * 
 * NOTE: this node is a copy of Node 7, with a different address
 * and configured so that only one bank of inputs is used. Also the
 * pin assignments are different.  However, the commands are 
 * exactly the same, even though bank 1 is not used.
 * 
...
// Define the pins...
#define PIN_S1    4       // For Node 7: 14   // Input 0
#define PIN_S2    7       // For Node 7: 11   // Input 1
#define PIN_S3    8       // For Node 7: 10   // Input 2
#define PIN_S4    14      // For Node 7:  9   // Input 3
#define PIN_S5    15      // For Node 7:  8   // Input 4
#define PIN_S6    16      // For Node 7:  7   // Input 5
#define PIN_S7    17      // For Node 7:  6   // Input 6
#define PIN_S8    18      // For Node 7:  5   // Input 7
// #define PIN_S9    00   // For Node 7:  4   // Input 8
// #define PIN_S10   00   // For Node 7:  3   // Input 9
// #define PIN_S11   00   // For Node 7: 15   // Input 10
// #define PIN_S12   00   // For Node 7: 16   // Input 11
// #define PIN_S13   00   // For Node 7: 17   // Input 12
// #define PIN_S14   00   // For Node 7: 18   // Input 13
// #define PIN_S15   00   // For Node 7: 19   // Input 14
