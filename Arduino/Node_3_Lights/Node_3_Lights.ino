 ...
 * *** Address = 3
 * 
 * This module is for the Light Control Unit in the play field.  The
 * hardware is set up to control six 12v lamps, and one neostrip,30 LEDs long. 
 * 
 ...
 *   6 (9)  NEO_BLINK     NeoPixel Blink Args: C1(3), C2(3), N1(1), N2(1), Wait(1)
...
uint8_t neo_mode = NEO_DEMO;  // At power up, start with the Demo until host tells us what to do.
